		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_project_ai_app.my_test_app", "spec.env_vars.0.name", initialStateEnvVars[0].Name),
					resource.TestCheckResourceAttr("ovh_cloud_project_ai_app.my_test_app", "spec.env_vars.0.value", *initialStateEnvVars[0].Value),
					resource.TestCheckResourceAttr("ovh_cloud_project_ai_app.my_test_app", "spec.default_http_port", "8080"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_project_ai_app.my_test_app", "spec.env_vars.0.name", updatedStateEnvVars[1].Name),
					resource.TestCheckResourceAttr("ovh_cloud_project_ai_app.my_test_app", "spec.env_vars.0.value", *updatedStateEnvVars[1].Value),
					resource.TestCheckResourceAttr("ovh_cloud_project_ai_app.my_test_app", "spec.default_http_port", fmt.Sprintf("%d", *updatedState.DefaultHttpPort)),
					resource.TestCheckResourceAttr("ovh_cloud_project_ai_app.my_test_app", "spec.grpc_port", fmt.Sprintf("%d", *updatedState.GrpcPort)),
				),
			},
		},
	})
