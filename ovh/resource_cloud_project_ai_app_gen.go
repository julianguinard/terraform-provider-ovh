		...
		"liveness_probe": schema.SingleNestedAttribute{
			Attributes: map[string]schema.Attribute{
				...
				"timeout_seconds": schema.Int64Attribute{
					...
					MarkdownDescription: "Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1.",
				},
			},
			CustomType: LivenessProbeType{
				ObjectType: types.ObjectType{
					AttrTypes: LivenessProbeValue{}.AttributeTypes(ctx),
				},
			},
			Optional:            true,
			Computed:            true,
			Description:         "App liveness probe",
			MarkdownDescription: "App liveness probe",
		},
		"name": schema.StringAttribute{
			CustomType:          ovhtypes.TfStringType{},
			Optional:            true,
		...
		"spec": schema.SingleNestedAttribute{
			Attributes: map[string]schema.Attribute{
				...
				"liveness_probe": schema.SingleNestedAttribute{
					...
					CustomType: SpecLivenessProbeType{
						ObjectType: types.ObjectType{
							AttrTypes: SpecLivenessProbeValue{}.AttributeTypes(ctx),
						},
					},
					Computed:            true,
					Description:         "App liveness probe",
...
type CloudProjectAiAppModel struct {
	...
	LivenessProbe      LivenessProbeValue                                 `tfsdk:"liveness_probe" json:"livenessProbe"`
...
func (v *CloudProjectAiAppModel) MergeWith(other *CloudProjectAiAppModel) {
	...
	if (v.LivenessProbe.IsUnknown() || v.LivenessProbe.IsNull()) && !other.LivenessProbe.IsUnknown() {
		v.LivenessProbe = other.LivenessProbe
	}
...
func (v CloudProjectAiAppModel) ToCreate() *CloudProjectAiAppModel {
	...
	if !v.LivenessProbe.IsUnknown() {
		res.LivenessProbe = *v.LivenessProbe.ToCreate()
	}
...
func (v *CloudProjectAiAppModel) MarshalJSON() ([]byte, error) {
	...
	if !v.LivenessProbe.IsNull() && !v.LivenessProbe.IsUnknown() {
		toMarshal["livenessProbe"] = v.LivenessProbe
	}
...
var _ basetypes.ObjectTypable = LivenessProbeType{}

type LivenessProbeType struct {
	basetypes.ObjectType
}

func (t LivenessProbeType) Equal(o attr.Type) bool {
	other, ok := o.(LivenessProbeType)
...
func (t LivenessProbeType) String() string {
	return "LivenessProbeType"
}

func (t LivenessProbeType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	var diags diag.Diagnostics

	attributes := in.Attributes()

	failureThresholdAttribute, ok := attributes["failure_threshold"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`failure_threshold is missing from object`)

		return nil, diags
	}

	failureThresholdVal, ok := failureThresholdAttribute.(ovhtypes.TfInt64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`failure_threshold expected to be ovhtypes.TfInt64Value, was: %T`, failureThresholdAttribute))
	}

	initialDelaySecondsAttribute, ok := attributes["initial_delay_seconds"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`initial_delay_seconds is missing from object`)

		return nil, diags
	}

	initialDelaySecondsVal, ok := initialDelaySecondsAttribute.(ovhtypes.TfInt64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`initial_delay_seconds expected to be ovhtypes.TfInt64Value, was: %T`, initialDelaySecondsAttribute))
	}
	...
	periodSecondsAttribute, ok := attributes["period_seconds"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`period_seconds is missing from object`)

		return nil, diags
	}

	periodSecondsVal, ok := periodSecondsAttribute.(ovhtypes.TfInt64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`period_seconds expected to be ovhtypes.TfInt64Value, was: %T`, periodSecondsAttribute))
	}
	...
	successThresholdAttribute, ok := attributes["success_threshold"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`success_threshold is missing from object`)

		return nil, diags
	}

	successThresholdVal, ok := successThresholdAttribute.(ovhtypes.TfInt64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`success_threshold expected to be ovhtypes.TfInt64Value, was: %T`, successThresholdAttribute))
	}
	...
	timeoutSecondsVal, ok := timeoutSecondsAttribute.(ovhtypes.TfInt64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`timeout_seconds expected to be ovhtypes.TfInt64Value, was: %T`, timeoutSecondsAttribute))
	}
	...
	return LivenessProbeValue{
		FailureThreshold:    failureThresholdVal,
		InitialDelaySeconds: initialDelaySecondsVal,
		Path:                pathVal,
		PeriodSeconds:       periodSecondsVal,
		Port:                portVal,
		SuccessThreshold:    successThresholdVal,
		TimeoutSeconds:      timeoutSecondsVal,
		state:               attr.ValueStateKnown,
	}, diags
}

func NewLivenessProbeValueNull() LivenessProbeValue {
	return LivenessProbeValue{
		state: attr.ValueStateNull,
	}
}

func NewLivenessProbeValueUnknown() LivenessProbeValue {
	return LivenessProbeValue{
		state: attr.ValueStateUnknown,
	}
}

func NewLivenessProbeValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (LivenessProbeValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing LivenessProbeValue Attribute Value",
				"While creating a LivenessProbeValue value, a missing attribute value was detected. "+
					"A LivenessProbeValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("LivenessProbeValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid LivenessProbeValue Attribute Type",
				"While creating a LivenessProbeValue value, an invalid attribute value was detected. "+
					"A LivenessProbeValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("LivenessProbeValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("LivenessProbeValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra LivenessProbeValue Attribute Value",
				"While creating a LivenessProbeValue value, an extra attribute value was detected. "+
					"A LivenessProbeValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra LivenessProbeValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewLivenessProbeValueUnknown(), diags
	}
...
func NewLivenessProbeValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) LivenessProbeValue {
	object, diags := NewLivenessProbeValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewLivenessProbeValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t LivenessProbeType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewLivenessProbeValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewLivenessProbeValueUnknown(), nil
	}
	...
	return NewLivenessProbeValueMust(LivenessProbeValue{}.AttributeTypes(ctx), attributes), nil
}

func (t LivenessProbeType) ValueType(ctx context.Context) attr.Value {
	return LivenessProbeValue{}
}

var _ basetypes.ObjectValuable = LivenessProbeValue{}

type LivenessProbeValue struct {
	FailureThreshold    ovhtypes.TfInt64Value  `tfsdk:"failure_threshold" json:"failureThreshold"`
	InitialDelaySeconds ovhtypes.TfInt64Value  `tfsdk:"initial_delay_seconds" json:"initialDelaySeconds"`
	Path                ovhtypes.TfStringValue `tfsdk:"path" json:"path"`
	PeriodSeconds       ovhtypes.TfInt64Value  `tfsdk:"period_seconds" json:"periodSeconds"`
	Port                ovhtypes.TfInt64Value  `tfsdk:"port" json:"port"`
	SuccessThreshold    ovhtypes.TfInt64Value  `tfsdk:"success_threshold" json:"successThreshold"`
	TimeoutSeconds      ovhtypes.TfInt64Value  `tfsdk:"timeout_seconds" json:"timeoutSeconds"`
	state               attr.ValueState
}

func (v LivenessProbeValue) ToCreate() *LivenessProbeValue {
	res := &LivenessProbeValue{}

	if !v.Path.IsNull() {
		res.Path = v.Path
	}

	if !v.PeriodSeconds.IsNull() {
		res.PeriodSeconds = v.PeriodSeconds
	}
	...
	if !v.SuccessThreshold.IsNull() {
		res.SuccessThreshold = v.SuccessThreshold
	}

	if !v.TimeoutSeconds.IsNull() {
		res.TimeoutSeconds = v.TimeoutSeconds
	}

	if !v.FailureThreshold.IsNull() {
		res.FailureThreshold = v.FailureThreshold
	}

	if !v.InitialDelaySeconds.IsNull() {
		res.InitialDelaySeconds = v.InitialDelaySeconds
	}
...
func (v LivenessProbeValue) MarshalJSON() ([]byte, error) {
	toMarshal := map[string]any{}
	if !v.FailureThreshold.IsNull() && !v.FailureThreshold.IsUnknown() {
		toMarshal["failureThreshold"] = v.FailureThreshold
	}
	if !v.InitialDelaySeconds.IsNull() && !v.InitialDelaySeconds.IsUnknown() {
		toMarshal["initialDelaySeconds"] = v.InitialDelaySeconds
	}
	if !v.Path.IsNull() && !v.Path.IsUnknown() {
		toMarshal["path"] = v.Path
	}
	if !v.PeriodSeconds.IsNull() && !v.PeriodSeconds.IsUnknown() {
		toMarshal["periodSeconds"] = v.PeriodSeconds
	}
	if !v.Port.IsNull() && !v.Port.IsUnknown() {
		toMarshal["port"] = v.Port
	}
	if !v.SuccessThreshold.IsNull() && !v.SuccessThreshold.IsUnknown() {
		toMarshal["successThreshold"] = v.SuccessThreshold
	}
	if !v.TimeoutSeconds.IsNull() && !v.TimeoutSeconds.IsUnknown() {
		toMarshal["timeoutSeconds"] = v.TimeoutSeconds
	}

	return json.Marshal(toMarshal)
}

func (v *LivenessProbeValue) UnmarshalJSON(data []byte) error {
	type JsonLivenessProbeValue LivenessProbeValue

	var tmp JsonLivenessProbeValue
	if err := json.Unmarshal(data, &tmp); err != nil {
		return err
	}
	v.FailureThreshold = tmp.FailureThreshold
	v.InitialDelaySeconds = tmp.InitialDelaySeconds
	v.Path = tmp.Path
	v.PeriodSeconds = tmp.PeriodSeconds
	v.Port = tmp.Port
	v.SuccessThreshold = tmp.SuccessThreshold
	v.TimeoutSeconds = tmp.TimeoutSeconds
...
func (v *LivenessProbeValue) MergeWith(other *LivenessProbeValue) {

	if (v.FailureThreshold.IsUnknown() || v.FailureThreshold.IsNull()) && !other.FailureThreshold.IsUnknown() {
		v.FailureThreshold = other.FailureThreshold
	}

	if (v.InitialDelaySeconds.IsUnknown() || v.InitialDelaySeconds.IsNull()) && !other.InitialDelaySeconds.IsUnknown() {
		v.InitialDelaySeconds = other.InitialDelaySeconds
	}
	...
	if (v.PeriodSeconds.IsUnknown() || v.PeriodSeconds.IsNull()) && !other.PeriodSeconds.IsUnknown() {
		v.PeriodSeconds = other.PeriodSeconds
	}
	...
	if (v.SuccessThreshold.IsUnknown() || v.SuccessThreshold.IsNull()) && !other.SuccessThreshold.IsUnknown() {
		v.SuccessThreshold = other.SuccessThreshold
	}

	if (v.TimeoutSeconds.IsUnknown() || v.TimeoutSeconds.IsNull()) && !other.TimeoutSeconds.IsUnknown() {
		v.TimeoutSeconds = other.TimeoutSeconds
	}
...
func (v LivenessProbeValue) Attributes() map[string]attr.Value {
	return map[string]attr.Value{
...
func (v LivenessProbeValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	attrTypes := make(map[string]tftypes.Type, 7)

	var val tftypes.Value
	var err error

	attrTypes["failure_threshold"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["initial_delay_seconds"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["path"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["period_seconds"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["port"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["success_threshold"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.FailureThreshold.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["failure_threshold"] = val

		val, err = v.InitialDelaySeconds.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["initial_delay_seconds"] = val
		...
		val, err = v.PeriodSeconds.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["period_seconds"] = val
		...
		val, err = v.SuccessThreshold.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["success_threshold"] = val
...
func (v LivenessProbeValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v LivenessProbeValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v LivenessProbeValue) String() string {
	return "LivenessProbeValue"
}

func (v LivenessProbeValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics

	objVal, diags := types.ObjectValue(
		map[string]attr.Type{
			"failure_threshold":     ovhtypes.TfInt64Type{},
			"initial_delay_seconds": ovhtypes.TfInt64Type{},
			"path":                  ovhtypes.TfStringType{},
			"period_seconds":        ovhtypes.TfInt64Type{},
			"port":                  ovhtypes.TfInt64Type{},
			"success_threshold":     ovhtypes.TfInt64Type{},
			"timeout_seconds":       ovhtypes.TfInt64Type{},
		},
		map[string]attr.Value{
			"failure_threshold":     v.FailureThreshold,
			"initial_delay_seconds": v.InitialDelaySeconds,
			"path":                  v.Path,
			"period_seconds":        v.PeriodSeconds,
			"port":                  v.Port,
			"success_threshold":     v.SuccessThreshold,
...
func (v LivenessProbeValue) Equal(o attr.Value) bool {
	other, ok := o.(LivenessProbeValue)
	...
	if !v.FailureThreshold.Equal(other.FailureThreshold) {
		return false
	}

	if !v.InitialDelaySeconds.Equal(other.InitialDelaySeconds) {
		return false
	}
	...
	if !v.PeriodSeconds.Equal(other.PeriodSeconds) {
		return false
	}
	...
	if !v.SuccessThreshold.Equal(other.SuccessThreshold) {
		return false
	}
...
func (v LivenessProbeValue) Type(ctx context.Context) attr.Type {
	return LivenessProbeType{
		basetypes.ObjectType{
			AttrTypes: v.AttributeTypes(ctx),
		},
...
func (v LivenessProbeValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
	return map[string]attr.Type{
		"failure_threshold":     ovhtypes.TfInt64Type{},
		"initial_delay_seconds": ovhtypes.TfInt64Type{},
		"path":                  ovhtypes.TfStringType{},
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	livenessProbeAttribute, ok := attributes["liveness_probe"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`liveness_probe is missing from object`)

		return nil, diags
	}

	livenessProbeVal, ok := livenessProbeAttribute.(SpecLivenessProbeValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`liveness_probe expected to be SpecLivenessProbeValue, was: %T`, livenessProbeAttribute))
	}
	...
	return SpecValue{
		...
		Image:              imageVal,
		Labels:             labelsVal,
		LivenessProbe:      livenessProbeVal,
		Name:               nameVal,
...
type SpecValue struct {
	...
	Image              ovhtypes.TfStringValue                             `tfsdk:"image" json:"image"`
	Labels             ovhtypes.TfMapNestedValue[ovhtypes.TfStringValue]  `tfsdk:"labels" json:"labels"`
	LivenessProbe      SpecLivenessProbeValue                             `tfsdk:"liveness_probe" json:"livenessProbe"`
	Name               ovhtypes.TfStringValue                             `tfsdk:"name" json:"name"`
	PartnerId          ovhtypes.TfStringValue                             `tfsdk:"partner_id" json:"partnerId"`
...
func (v *SpecValue) UnmarshalJSON(data []byte) error {
	...
	v.Image = tmp.Image
	v.Labels = tmp.Labels
	v.LivenessProbe = tmp.LivenessProbe
	v.Name = tmp.Name
...
func (v *SpecValue) MergeWith(other *SpecValue) {
	...
	if v.LivenessProbe.IsUnknown() && !other.LivenessProbe.IsUnknown() {
		v.LivenessProbe = other.LivenessProbe
	} else if !other.LivenessProbe.IsUnknown() {
		v.LivenessProbe.MergeWith(&other.LivenessProbe)
	}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["liveness_probe"] = basetypes.ObjectType{
		AttrTypes: SpecLivenessProbeValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	attrTypes["name"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.LivenessProbe.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["liveness_probe"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	objVal, diags := types.ObjectValue(
		map[string]attr.Type{
			...
			"liveness_probe": SpecLivenessProbeType{
				basetypes.ObjectType{
					AttrTypes: SpecLivenessProbeValue{}.AttributeTypes(ctx),
				},
			},
		...
		map[string]attr.Value{
			...
			"image":               v.Image,
			"labels":              v.Labels,
			"liveness_probe":      v.LivenessProbe,
			"name":                v.Name,
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.LivenessProbe.Equal(other.LivenessProbe) {
		return false
	}
...
func (v SpecValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
	return map[string]attr.Type{
		...
		"image":               ovhtypes.TfStringType{},
		"labels":              ovhtypes.NewTfMapNestedType[ovhtypes.TfStringValue](ctx),
		"liveness_probe":      SpecLivenessProbeValue{}.Type(ctx),
		"name":                ovhtypes.TfStringType{},
		"partner_id":          ovhtypes.TfStringType{},
...
var _ basetypes.ObjectTypable = SpecLivenessProbeType{}

type SpecLivenessProbeType struct {
	basetypes.ObjectType
}

func (t SpecLivenessProbeType) Equal(o attr.Type) bool {
	other, ok := o.(SpecLivenessProbeType)
...
func (t SpecLivenessProbeType) String() string {
	return "SpecLivenessProbeType"
}

func (t SpecLivenessProbeType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func NewSpecLivenessProbeValueNull() SpecLivenessProbeValue {
	return SpecLivenessProbeValue{
		state: attr.ValueStateNull,
	}
}

func NewSpecLivenessProbeValueUnknown() SpecLivenessProbeValue {
	return SpecLivenessProbeValue{
		state: attr.ValueStateUnknown,
	}
}

func NewSpecLivenessProbeValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (SpecLivenessProbeValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing SpecLivenessProbeValue Attribute Value",
				"While creating a SpecLivenessProbeValue value, a missing attribute value was detected. "+
					"A SpecLivenessProbeValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("SpecLivenessProbeValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid SpecLivenessProbeValue Attribute Type",
				"While creating a SpecLivenessProbeValue value, an invalid attribute value was detected. "+
					"A SpecLivenessProbeValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("SpecLivenessProbeValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("SpecLivenessProbeValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra SpecLivenessProbeValue Attribute Value",
				"While creating a SpecLivenessProbeValue value, an extra attribute value was detected. "+
					"A SpecLivenessProbeValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra SpecLivenessProbeValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewSpecLivenessProbeValueUnknown(), diags
	}
...
func NewSpecLivenessProbeValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) SpecLivenessProbeValue {
	object, diags := NewSpecLivenessProbeValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewSpecLivenessProbeValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t SpecLivenessProbeType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewSpecLivenessProbeValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewSpecLivenessProbeValueUnknown(), nil
	}
	...
	return NewSpecLivenessProbeValueMust(SpecLivenessProbeValue{}.AttributeTypes(ctx), attributes), nil
}

func (t SpecLivenessProbeType) ValueType(ctx context.Context) attr.Value {
	return SpecLivenessProbeValue{}
}

var _ basetypes.ObjectValuable = SpecLivenessProbeValue{}

type SpecLivenessProbeValue struct {
	FailureThreshold    ovhtypes.TfInt64Value  `tfsdk:"failure_threshold" json:"failureThreshold"`
	InitialDelaySeconds ovhtypes.TfInt64Value  `tfsdk:"initial_delay_seconds" json:"initialDelaySeconds"`
	Path                ovhtypes.TfStringValue `tfsdk:"path" json:"path"`
	PeriodSeconds       ovhtypes.TfInt64Value  `tfsdk:"period_seconds" json:"periodSeconds"`
...
func (v *SpecLivenessProbeValue) UnmarshalJSON(data []byte) error {
	type JsonSpecLivenessProbeValue SpecLivenessProbeValue

	var tmp JsonSpecLivenessProbeValue
	if err := json.Unmarshal(data, &tmp); err != nil {
		return err
	}
	v.FailureThreshold = tmp.FailureThreshold
...
func (v *SpecLivenessProbeValue) MergeWith(other *SpecLivenessProbeValue) {
...
func (v SpecLivenessProbeValue) Attributes() map[string]attr.Value {
	return map[string]attr.Value{
		"failureThreshold":    v.FailureThreshold,
		"initialDelaySeconds": v.InitialDelaySeconds,
		"path":                v.Path,
...
func (v SpecLivenessProbeValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	attrTypes := make(map[string]tftypes.Type, 7)
...
func (v SpecLivenessProbeValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v SpecLivenessProbeValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v SpecLivenessProbeValue) String() string {
	return "SpecLivenessProbeValue"
}

func (v SpecLivenessProbeValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v SpecLivenessProbeValue) Equal(o attr.Value) bool {
	other, ok := o.(SpecLivenessProbeValue)
...
func (v SpecLivenessProbeValue) Type(ctx context.Context) attr.Type {
	return SpecLivenessProbeType{
		basetypes.ObjectType{
			AttrTypes: v.AttributeTypes(ctx),
		},
...
func (v SpecLivenessProbeValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
	return map[string]attr.Type{
		"failure_threshold":     ovhtypes.TfInt64Type{},
		"initial_delay_seconds": ovhtypes.TfInt64Type{},
		"path":                  ovhtypes.TfStringType{},
